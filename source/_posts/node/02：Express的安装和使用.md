...
# 一、Express的安装和基本使用
1. 介绍： 
    - [Express](https://www.expressjs.com.cn/) 是基于Node.Js平台，快速，开放，极简的Web开发框架。类似js中的jQuery。 
...
3. [安装之后，需要在文件引入才能使用](https://www.expressjs.com.cn/starter/hello-world.html)： 
    - `const express = require("express");`
        * express自身是一个函数，执行之后，得到express对象
    - `const app = express();`
...
# 五、express的项目生成器
+ 通过应用 [生成器工具](https://www.expressjs.com.cn/starter/generator.html) express-generator 可以快速创建一个应用的骨架。
1. 在命令提示符中依次执行以下命令：
    1. 下载生成器（脚手架）
...
3. ejs模版语法介绍：
    - 变量的定义和渲染：
        * 定义：
            ...
            定义公共模板(views/header.ejs):
            ```html
            <div>这是公共的头部内容</div>
            ```

            引入公共模板(views/index.ejs):
            ```html
            <%- include("./header.ejs") %>
            ```
